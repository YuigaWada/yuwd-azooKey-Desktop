...
extension Config {
    struct OpenAiApiKey: StringConfigItem {
        static var key: String = "dev.yuiga.inputmethod.azooKeyMac.preference.OpenAiApiKey"
...
extension Config {
    struct ZenzaiProfile: StringConfigItem {
        static var key: String = "dev.yuiga.inputmethod.azooKeyMac.preference.ZenzaiProfile"
    }
}
...
extension Config {
    ...
    struct OpenAiModelName: StringConfigItem {
        ...
        static var key: String = "dev.yuiga.inputmethod.azooKeyMac.preference.OpenAiModelName"
    }

    /// OpenAI API エンドポイント
    struct OpenAiApiEndpoint: StringConfigItem {
        static let `default` = "https://api.openai.com/v1/chat/completions"
        static var key: String = "dev.yuiga.inputmethod.azooKeyMac.preference.OpenAiApiEndpoint"
    ...
    struct PromptHistory: StringConfigItem {
        static var key: String = "dev.yuiga.inputmethod.azooKeyMac.preference.PromptHistory"
    }
}
